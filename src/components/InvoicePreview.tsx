    ...
    >
      ...
      <div className="relative bg-[#0a2353] pt-8 pb-10 pl-8 pr-8 text-white border-b-0 rounded-t-[2rem] overflow-hidden flex items-center justify-between">
        ...
        <div className="flex flex-col items-end z-10 text-right space-y-2">
            ...
            <div className="flex items-center gap-1.5 bg-white/15 text-white px-3 py-1 rounded-full font-bold shadow-sm border border-white/30">
        ...
        <div className="rounded-[1rem] overflow-hidden shadow-[0_4px_16px_rgba(0,0,0,0.06)] flex flex-col bg-white relative">
          ...
          <div className="bg-slate-50 px-4 py-2 border-b border-slate-200 flex items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-[11px] font-extrabold text-slate-800 tracking-wider uppercase">Account Status</span>
            </div>
            <span className="inline-flex items-center gap-1.5 px-2.5 py-0.5 rounded-full text-[10px] font-black bg-emerald-600 text-white shadow-sm uppercase tracking-wider border border-emerald-500/80">
          ...
          {/* Right Column: Distinct Elegant Off-White / Subtle Muted Tone */}
          <div className="w-[28%] bg-slate-50/90 border-l border-slate-200 flex flex-col items-center justify-center p-4 relative overflow-hidden">
            <div className="relative flex flex-col items-center z-10 w-full mb-2 mt-1">
                {/* ID Activation Success Icon - Green */}
                <div className="relative w-16 h-16 flex items-center justify-center bg-emerald-100 rounded-full shadow-inner border border-emerald-200/60">
                   <div className="w-12 h-12 bg-[#22c55e] rounded-full flex items-center justify-center shadow-md">
                     <svg viewBox="0 0 24 24" className="w-7 h-7 text-white fill-none stroke-current" strokeWidth="3.5">
            ...
            {/* Typography */}
            <div className="flex flex-col items-center text-center z-10 mt-2 pb-1">
                <span className="text-[12.5px] font-black text-slate-900 tracking-wider leading-tight uppercase">
                  ID ACTIVATION
                </span>
                <span className="text-[12.5px] font-black text-emerald-600 tracking-widest mt-0.5 uppercase drop-shadow-sm">
                  SUCCESSFUL
                </span>
            </div>
          </div>
      ...
      <div className="border-t border-slate-200 px-6 py-4 bg-white flex items-center justify-between mt-auto">
        {/* Transaction ID Info */}
        <div className="w-[33%] flex flex-col items-start">
          <span className="text-[8.5px] text-slate-500 font-bold tracking-wider uppercase">
            TRANSACTION ID
          </span>
          <span className="text-[14px] font-mono font-bold text-slate-900 mt-0.5 tracking-wide">
            #{transactionId}
          </span>
          {/* Handwritten ink signature */}
          <div className="mt-1 flex flex-col items-start">
            <svg viewBox="0 0 140 40" className="w-28 h-7 text-blue-600 opacity-90 -mb-1 transform -rotate-1">
              <path
            ...
            <span className="text-[7.5px] text-slate-500 font-bold tracking-wider uppercase leading-none mt-0.5">
        ...
        <div className="w-[34%] flex flex-col items-center justify-center text-center">
          <span className="text-[8.5px] text-slate-500 font-bold tracking-wider uppercase mb-1.5">
            SCAN TO VISIT
          </span>
          <div className="relative p-1 bg-white border border-slate-200 rounded-md shadow-sm">
            <div className="absolute -top-1 -left-1 w-2.5 h-2.5 border-t-2 border-l-2 border-[#2563eb]"></div>
            <div className="absolute -top-1 -right-1 w-2.5 h-2.5 border-t-2 border-r-2 border-[#2563eb]"></div>
            <div className="absolute -bottom-1 -left-1 w-2.5 h-2.5 border-b-2 border-l-2 border-[#2563eb]"></div>
            <div className="absolute -bottom-1 -right-1 w-2.5 h-2.5 border-b-2 border-r-2 border-[#2563eb]"></div>
        ...
        <div className="w-[33%] flex flex-col items-end text-right">
          ...
          <a
            ...
            className="text-[12px] font-bold text-blue-600 hover:underline mt-0.5"
          >
            {companyWebsite}
          </a>
          ...
          <div className="flex items-center gap-2 mt-1.5">
            <div className="w-5 h-5 rounded-full bg-blue-50 text-[#1877F2] flex items-center justify-center shadow-sm border border-blue-100">
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current">
                <path d="M24 12.073c0-6.627-5.373-12-12-12s-12 5.373-12 12c0 5.99 4.388 10.954 10.125 11.854v-8.385H7.078v-3.47h3.047V9.43c0-3.007 1.792-4.669 4.533-4.669 1.312 0 2.686.235 2.686.235v2.953H15.83c-1.491 0-1.956.925-1.956 1.874v2.25h3.328l-.532 3.47h-2.796v8.385C19.612 23.027 24 18.062 24 12.073z" />
              </svg>
            </div>
            <div className="w-5 h-5 rounded-full bg-red-50 text-[#FF0000] flex items-center justify-center shadow-sm border border-red-100">
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current">
                <path d="M23.498 6.163a3.003 3.003 0 0 0-2.11-2.11C19.518 3.545 12 3.545 12 3.545s-7.518 0-9.388.507a3.003 3.003 0 0 0-2.11 2.11C0 8.033 0 12 0 12s0 3.967.502 5.837a3.003 3.003 0 0 0 2.11 2.11c1.87.507 9.388.507 9.388.507s7.518 0 9.388-.507a3.003 3.003 0 0 0 2.11-2.11C24 15.967 24 12 24 12s0-3.967-.502-5.837zM9.545 15.568V8.432L15.818 12l-6.273 3.568z" />
              </svg>
            </div>
            <div className="w-5 h-5 rounded-full bg-sky-50 text-[#0088cc] flex items-center justify-center shadow-sm border border-sky-100">
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current">
            ...
            <div className="w-5 h-5 rounded-full bg-emerald-50 text-[#25D366] flex items-center justify-center shadow-sm border border-emerald-100">
              <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 fill-current">
      ...
      <div className="bg-[#0a2353] text-white py-2.5 px-6 flex justify-between items-center text-[10px] rounded-b-[2rem] border-t border-blue-900/50">
        <div className="flex items-center gap-2">
          <div className="w-5 h-5 rounded-full bg-white/15 flex items-center justify-center border border-white/20">
            <svg viewBox="0 0 24 24" className="w-3.5 h-3.5 text-[#38bdf8] fill-none stroke-current" strokeWidth="2.5">
              <path d="M22 10v6M2 10l10-5 10 5-10 5z" />
              <path d="M6 12v5c3 3 9 3 12 0v-5" />
            </svg>
          </div>
          <span className="font-extrabold tracking-wider uppercase text-white">{companyName.toUpperCase()} E-LEARNING PLATFORM</span>
        </div>
        <div className="flex items-center gap-1.5">
          <span className="font-semibold text-blue-200">Your Success, Our Priority</span>
          <span className="text-rose-500 text-[12px] animate-pulse drop-shadow">❤️</span>
        </div>
      </div>
    </div>
  );
